...
public class WalkingState : State
{
    ...
    // Construtor
    public WalkingState(ControllerPlayer controllerPlayer) : base("WalkingState")
    {
    ...
    public override void Update()
    {
        ...
        if(controller.isground){
            ...
            moveDirection = moveDirection.normalized* controller.speedMoviment;
            ...
            Vector3 flatVel =  new Vector3(
                ...
                if(flatVel.magnitude > controller.speedMoviment){
                    Vector3 limitMoviment = flatVel.normalized * controller.speedMoviment;
